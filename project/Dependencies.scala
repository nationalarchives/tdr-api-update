...
object Dependencies {
  ...
  lazy val backendCheckUtils = "uk.gov.nationalarchives" %% "tdr-backend-checks-utils" % "0.1.23"
  ...
  lazy val wiremockStandalone = "com.github.tomakehurst" % "wiremock-standalone" % "3.0.0"
