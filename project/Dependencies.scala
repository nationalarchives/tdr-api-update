...
object Dependencies {
  ...
  lazy val awsSsm = "software.amazon.awssdk" % "ssm" % "2.35.11"
  ...
  lazy val generatedGraphql = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.441"
  ...
  lazy val authUtils = "uk.gov.nationalarchives" %% "tdr-auth-utils" % "0.0.261"
}
